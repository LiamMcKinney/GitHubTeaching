...
/**
 * DISCLAIMER: This is NOT applicable for actual robot code. It is only meant
 * for seeing if stuff works for teams without a robot This class is meant to
 * simulate the behavior of a gyro and is to be used in conjuntion with the
 * simulation
 * 
 * It contains methods designed to extract data on robot direction, angle, and
 * angular speed
 * 
 * It contains numerical constants specific to the gyro's behavior and also to
 * the robot
 * 
...
public class SimulatedGyro { 
    ...
    /**
     * creates a Simulated Gyro
     * @param leftFront a SimulatedTalon on the left side of the robot.
     * @param rightFront a SimulatedTalon on the right side of the robot.
     * @param width The width of the robot, in feet. If in doubt, say 3.
     */
    ...
    /**
     * get the angle that the robot is facing. 0 is the same direction it was facing when turned on
